...
<title>Censo Alimenticio | Gráfica 9</title>
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            ?>         
             ...
             <script type="text/javascript">
              ...
              function drawChart() {
                ...
                var options = {
                  title: 'Práctica de deportes de <?php echo "$row_counti";?> Alumnos de Estadística',
                  pieHole: 0.4,
                };
            ...
            <div id="donutchart" style="width: 900px; height: 500px;"></div>
             ...
             <a href="pregunta9.php" class="btn btn-primary btn-lg" role="button">Ver Tabla</a>
