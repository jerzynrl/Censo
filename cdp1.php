      ...
      <div class="container clear_both padding_fix">
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <!--CUARTILES-->
          <div class="block-web">
            <center><a href="cuartil1.php"><h4>Click para calcular CUARTIL</h4></a>
            ...
            <!--DECIL-->
          <div class="block-web">
            <center><a href="decil1.php"><h4>Click para calcular DECIL</h4></a>
          ...
          <!--/row-->
            ...
            <?php
            try{
            $sentencia = $conn->query("SELECT * FROM encuesta ORDER BY edad ASC;");
           ...
           ?>
            ...
            <tr>
                   <td><?=$n;?></td>
                   <td><?=$row["edad"];?></td>
                    <td><a href="percentil.php?id_encuesta=<?php echo $row["id_encuesta"]?>&posicion=<?php echo $n?>&back=1&tabla=edad">Calcular Percentil</a></td>
            </tr>
                <?php
            }
            ?>
