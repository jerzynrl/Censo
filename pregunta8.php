    ...
    <div class="contentpanel">
      ...
      <div class="container clear_both padding_fix">
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <p>Hora en que se duermen <b><?php echo "$row_counti";?></b> alumnos de Estadística Computacional, ciclo II - 2017.</p>
              ...
              <td>
                <?php
                $sentencia = $conn->query("select * from encuesta where h_sueno >='21:00:00' && h_sueno <= '21:59:59';");
              ...
              <td>
                <?php
                $sentencia = $conn->query("select * from encuesta where h_sueno >='22:00:00' && h_sueno <= '22:59:59';");
              ...
              <td>
                <?php
                $sentencia = $conn->query("select * from encuesta where h_sueno >='23:00:00' && h_sueno <= '23:59:59';");
              ...
              <td>
                <?php
                $sentencia = $conn->query("select * from encuesta where h_sueno >='00:00:00' && h_sueno <= '00:59:59';");
              ...
              <td>
                <?php
                $sentencia = $conn->query("select * from encuesta where h_sueno >='01:00:00' && h_sueno <= '01:59:59';");
              ...
              <td>
                <?php
                $sentencia = $conn->query("select * from encuesta where h_sueno >='02:00:00' && h_sueno <= '02:59:59';");
              ...
              <td>
                <?php
                $sentencia = $conn->query("select * from encuesta where h_sueno >='03:00:00' && h_sueno <= '03:59:59';");
        ...
        <!--Código para enviar datos para llenar las variables de la gráfica-->
            <form action="grafica8.php" method="post">
