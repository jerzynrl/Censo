        ...
        <div class="row">
          <div class="col-md-12">
            ...
            ?>
              ...
              <th colspan="11"><center><h6>TABLA DE FRECUENCIAS CON INTERVALOS EN GRUPOS DE 10 CM.</h6></center></th>

              <tr>
              <th>Intervalo en Metros</th>
              <td>1.50-1.60</td>
              <td>1.61-1.70</td>
              <td>1.71-1.80</td>
              <td>1.81-1.90</td>
              ...
              <td>
                <?php
                $sentencia = $conn->query("select * from encuesta where estatura>='1.50' && estatura <=1.60;");
              ...
              <td>
                <?php
                $sentencia = $conn->query("select * from encuesta where estatura>='1.61' && estatura <=1.70;");
              ...
              <td>
                <?php
                $sentencia = $conn->query("select * from encuesta where estatura>='1.71' && estatura <=1.80;");
              ...
              <td>
                <?php
                $sentencia = $conn->query("select * from encuesta where estatura>='1.81' && estatura <=1.90;");
              ...
              <td>
                <?php
                $sentencia = $conn->query("select * from encuesta where estatura>='1.91' && estatura <=2.00;");
            ...
            <div class="block-web">
              <div class="block widget-notes">
                <div contenteditable="true" class="paper">
                  <b>Dato Mínimo: </b>
                  <?php
                    $sentencia = $conn->query("select MIN(estatura) FROM encuesta;");
                    $row_countdmenor = $sentencia->fetchColumn();
                    echo ("$row_countdmenor"), ' m(s).';
                  ?><br>
                  <b>Dato Máximo: </b>
                  <?php
                    $sentencia = $conn->query("select MAX(estatura) FROM encuesta;");
                    $row_countdmayor = $sentencia->fetchColumn();
                    echo ("$row_countdmayor"), ' m(s).';
                  ?><br>
                  <b>Amplitud: </b><?php
           ...
           <!--Código para enviar datos para llenar las variables de la gráfica-->
            <form action="grafica3.php" method="post">
