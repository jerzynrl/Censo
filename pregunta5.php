      ...
      <div class="container clear_both padding_fix">
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <p>N° de entre comidas / snacks diarios de <b><?php echo "$row_counti";?></b> alumnos de Estadística Computacional, ciclo II - 2017.</p>
              ...
              <tr>
              <th colspan="6"><center><h6>TABLA DE FRECUENCIAS CON INTERVALOS DE N° DE ENTRE COMIDAS / SNACKS DIARIOS</h6></center></th>
              </tr>
            ...
            <div class="block-web">
              <div class="block widget-notes">
                <div contenteditable="true" class="paper">
                  <b>Dato Mínimo: </b>
                  <?php
                    $sentencia = $conn->query("select MIN(snack) FROM encuesta;");
                    $row_countdmenor = $sentencia->fetchColumn();
                    echo "$row_countdmenor";
                  ?><br>
                  <b>Dato Máximo: </b>
                  <?php
                    $sentencia = $conn->query("select MAX(snack) FROM encuesta;");
        ...
        <!--INICIO CODIGO PARA GRAFICA.-->
           ...
           <!--Código para enviar datos para llenar las variables de la gráfica-->
            <form action="grafica5.php" method="post">
