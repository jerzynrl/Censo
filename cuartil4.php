    ...
    <div class="contentpanel">
      ...
      <div class="pull-left breadcrumb_admin clear_both">
        <div class="pull-left page_title theme_color">
          <h1>cuartil de pregunta 4</h1> ¿CON CUÁNTAS DE LAS COMIDAS REGLAMENTARIAS CUMPLE DIARIAMENTE?
        </div>
      </div>
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            ?>
              ...
              <a href="cdp4.php" class="btn btn-primary btn-lg" role="button"><- Regresar</a>
