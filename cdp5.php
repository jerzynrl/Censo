      ...
      <div class="container clear_both padding_fix">
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <!--CUARTILES-->
          <div class="block-web">
            <center><a href="cuartil5.php"><h4>Click para calcular CUARTIL</h4></a>
            ...
            <!--DECIL-->
          <div class="block-web">
            <center><a href="decil5.php"><h4>Click para calcular DECIL</h4></a>
          ...
          <!--/row-->
            ...
            <?php
            try{
            $sentencia = $conn->query("SELECT * FROM encuesta ORDER BY snack ASC;");
            ...
            ?>
                ...
                <tr>
                   <th width="5%">N°</th>
                   <th width="10%">Entre comidas al día<br></th>
           ...
           ?>
            ...
            <tr>
                   <td><?=$n;?></td>
                   <td><?=$row["snack"];?></td>
                    <td><a href="percentil.php?id_encuesta=<?php echo $row["id_encuesta"]?>&posicion=<?php echo $n?>&back=5&tabla=snack">Calcular Percentil</a></td>
            </tr>
                <?php
            }
            ?>
