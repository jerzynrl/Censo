        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <p>Tipos de Alimentos que más consumen, de <b><?php echo "$row_counti";?></b> alumnos de Estadística Computacional, ciclo II - 2017.</p>
              ...
              <tr>
              <th colspan="9"><center><h6>TABLA DE FRECUENCIAS CON INTERVALOS DE TIPO DE ALIMENTOS</h6></center></th>
              </tr>

              <tr>
              <th>Intervalo en <br> Tipo de Alimento</th>
              <td>Frutas</td>
              <td>Verduras</td>
              <td>Mentequilla / Aceite</td>
              <td>Carnes / Huevos</td>
              <td>Lácteos</td>
              <td>Comidas Rápidas</td>
              <td>Panes / Cereales</td>
              <th>Total</th>
              </tr>
              ...
              <td>
                <?php
                $sentencia = $conn->query("select * from encuesta where alimento='Frutas';");
              ...
              <td>
                <?php
                $sentencia = $conn->query("select * from encuesta where alimento='Verduras';");
              ...
              <td>
                <?php
                $sentencia = $conn->query("select * from encuesta where alimento='Mantequilla / Aceite';");
              ...
              <td>
                <?php
                $sentencia = $conn->query("select * from encuesta where alimento='Carne / Huevos';");
              ...
              <td>
                <?php
                $sentencia = $conn->query("select * from encuesta where alimento='Lácteos';");
              ...
              <td>
                <?php
                $sentencia = $conn->query("select * from encuesta where alimento='Comidas Rápidas';");
              ...
              <td>
                <?php
                $sentencia = $conn->query("select * from encuesta where alimento='Panes / Cereales';");
            ...
            ?>
              ...
              <tr>
              <th>Clases <br> (Tipo de Alimentos)</th>
              <td>f <br> Alumnos</td>
              <td>fa <br> "o menos"</td>
              </tr>
         ...
         <!--Código para enviar datos para llenar las variables de la gráfica-->
            <form action="grafica6.php" method="post">
